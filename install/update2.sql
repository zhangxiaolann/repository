ALTER TABLE  `wjob_job` ADD  `type` INT( 4 ) NOT NULL DEFAULT  '0';

ALTER TABLE  `wjob_user` ADD  `qqnum` INT( 150 ) NOT NULL DEFAULT  '0',
ADD  `email` varchar(150) NULL;

ALTER TABLE `wjob_config` 
...
ALTER TABLE  `wjob_job` ADD  `cookie` text NULL;
