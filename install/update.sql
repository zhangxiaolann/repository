ALTER TABLE  `wjob_user`
ADD  `last` DATETIME NOT NULL;

ALTER TABLE  `wjob_job1` 
...
ALTER TABLE `wjob_config` DROP `jobtime`,
DROP `jobtimes`,
DROP `job1`,
DROP `job2`,
DROP `job3`,
...
ALTER TABLE  `wjob_config` ADD  `bulk` INT( 10 ) NOT NULL DEFAULT  '10',
...
update `wjob_config` set `adminid` ='1',`show` ='15分钟|15分钟|5分钟|5分钟|5分钟|6小时|6小时|12小时',`apiserver` ='1' where `id`='1'