...
('copyright', 'Copyright <a href="./">彩虹</a> <i class="fa fa-copyright"></i> 2017'),
...
<img border="0" width="32" src="images/new.gif">★本平台免费送VIP体验卡密哦，<a href="index.php?mod=free" class="btn btn-danger btn-xs">点击领取试用VIP</a>｜<a href="http://cron.105ka.com/" target="_blank" class="btn btn-success btn-xs">立即购买VIP会员获尊贵身份</a>
</p>
...
('shop', '<blockquote><p>
<a class="btn btn-success btn-block" href="http://cron.105ka.com/" target="_blank">点击进入自助购买卡密</a><br/>
<font color="blue">卡密分为VIP卡、充值卡和配额卡，都是在这个页面购买并激活。<br/>
如有问题请联系站长QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=1277180438&site=qq&menu=yes">1277180438</a></font>
</p></blockquote>'),
('qqlevel', '<a class="btn btn-success btn-block" href="./" target="_blank">请联系站长购买代挂卡密</a>'),
('footer', ''),
('interval', '50'),
('version', '7030'),
('switch', '1'),
...
('open_km', '1'),
('pay_api', '0'),
('buy_rules', '1|5|15|30|50|66|1|3|5|8'),
('ui_loading', '1'),
('ui_style', '1'),
('ui_style2', '3'),
('ui_index', '1'),
