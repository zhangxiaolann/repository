...
{
	echo'<div class="w nav"><a href="index.php">首页</a>&nbsp;&nbsp;<a href="index.php?mod=login">登录</a>&nbsp;&nbsp;<a href="index.php?mod=reg">注册</a></div>';
}
}
...
用户名：'.$row['user'].' <br>用户ID：'.$row['userid'];
if ($isadmin==1)echo'<font color=blue>(管理员)</font>';
