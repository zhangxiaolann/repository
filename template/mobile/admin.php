...
<label class="radio-inline"><input type="radio" name="type" value="user" checked="checked"/>用户</label>&nbsp;<label class="radio-inline"><input type="radio" name="type" value="job"/>任务</label>&nbsp;<label class="radio-inline"><input type="radio" name="type" value="qq"/>ＱＱ</label><br/>
...
●<a href="index.php?mod=admin-set&my=set_gg">广告与公告配置</a></div>';
