	...
	<ul align="center" class="list-group" style="list-style:none;">
		<li class="list-group-item"><div class="wrapper2">
			<div id="menubar" class="fix-menu">
				<div class="menu-list">
';
$rs=$DB->query("SELECT * FROM wjob_qq WHERE 1 order by id desc limit 24");
...
<div class="panel panel-primary" style="max-width:680px;">
	...
	<ul align="center" class="list-group" style="list-style:none;">
		...
		<li class="list-group-item"><img src="//q1.qlogo.cn/g?b=qq&nk='.$q.'&s=100&t='.time().'"><li>
		<li class="list-group-item"><img src="//qqshow-user.tencent.com/'.$q.'/22/00/1.gif?fr=mobileqq"><li>
