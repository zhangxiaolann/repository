...
<div class="panel panel-primary">
	<table class="table table-bordered">
		<tbody>
			...
			foreach($arr as $row) {
			echo '<tr><td uin="'.$row['uin'].'"><a href="tencent://message/?uin='.$row['uin'].'&amp;Site=&amp;Menu=yes">'.$row['uin'].'</a></td><td>'.$row['nick'].'</td><td id="to'.$row['uin'].'" uin="'.$row['uin'].'" class="nocheck recheck" align="center"><span class="btn btn-large btn-block btn-primary">检测</span></td><td uin="'.$row['uin'].'" class="qqdel" align="center"><span class="btn btn-large btn-block btn-danger">删除</span></td></tr>';
			}
			?>
		</tbody>
	</table>
