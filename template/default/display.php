...
<div class="modal fade" align="left" id="qqjob04" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
<?php
echo '<a class="btn btn-default btn-block" href="index.php?mod=qqjob&my=vipqd&qq='.$qq.'"><img src="images/icon/chen.ico" class="logo">添加QQ会员自动签到任务</a>';
...
echo '<a class="btn btn-default btn-block" href="index.php?mod=signer&my=pwsign&sys='.$sysid.'"><img src="images/icon/pw.ico" class="logo">添加phpwind自动签到任务</a>';
