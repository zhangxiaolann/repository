...
$qqrow=$DB->get_row("SELECT * FROM wjob_qq WHERE qq='{$qq}' limit 1");
...
<span class="dropdown">
   ...
   <ul class="dropdown-menu" role="menu">
	...
	<li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#qqjob01" href="#" id="qqlist01">其它类任务</a></li>
   </ul>
</span>
<span class="dropdown">
...
$gls=$DB->count("SELECT count(*) from wjob_job WHERE type='2' and lx='{$gl}'");
...
';
$sql="lx='{$gl}' and sysid='{$sysid}' and type=0";
}
...
<?php
$i=0;
$rs=$DB->query("SELECT * FROM wjob_job WHERE {$sql} order by jobid desc limit $pageu,$pagesize");
