		...
		<div class="sidebar">
			<div class="sidebar-collapse">
				...
				<div class="sidebar-header">
					<a href="./"><img src="images/<?php echo $logoname?>logo.png" alt="logo" width="100%" height="100%"/></a>
				</div>
				<!-- Sidebar Menu-->
				<div class="sidebar-menu">
					<nav id="menu" class="nav-main" role="navigation">
						<ul class="nav nav-sidebar">
							...
							<?php if($islogin==1) {?>
								<div class="bk-avatar">
									<img src="<?php echo ($row['qq'])?'//q2.qlogo.cn/headimg_dl?bs=qq&dst_uin='.$row['qq'].'&src_uin='.$row['qq'].'&fid='.$row['qq'].'&spec=100&url_enc=0&referer=bu_interface&term_type=PC':'assets/img/user.png'?>" class="img-circle bk-img-60" alt="" />
								</div>
