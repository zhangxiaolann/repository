...
<div class="panel-body">
答：登陆 <a href="https://aq.qq.com/cn2/safe_service/device_lock" target="_blank" rel="noreferrer">https://aq.qq.com/cn2/safe_service/device_lock</a> 这个页面，即可关闭所有的登陆保护，确保正常代挂不受影响。
</div>
</div>
</div>
<div class="panel panel-default">
...
<input type="text" class="form-control" name="km" value="" placeholder="输入激活码">
			...
			$msg='<div class="alert alert-info">首次开通请购买并输入代挂激活码，激活码将和你的QQ绑定。开通前请确保关闭设备锁和<a href="https://aq.qq.com/cn2/safe_service/device_lock" target="_blank" rel="noreferrer">登录保护</a>！';
		}else{
			showmsg($data);exit;
		}
	}else{
...
<small>温馨提示：代挂功能将会在晚上0点整系统自动进行代挂,请根据自身情况配合使用,比如：经常用手机的就无需开启手机QQ在线代挂功能。<br/>[ <a href="http://ptlogin2.qq.com/jump?uin=<?php echo $qq?>&skey=<?php echo $row['skey']?>&u1=http://id.qq.com/level2/index.html" target="_blank" rel="noreferrer">点此查询我的加速</a> ]</small>
</div>
</div>
<?php
}
