...
<title>手动导入PHPwind论坛cookie</title>
<link rel="stylesheet" type="text/css" href="../../assets/css/getcookie.css">
</head>
<body>
<div class="title">手动导入PHPwind论坛cookie</div>
<?php
/*
*PHPwind论坛cookie提取工具
*BY 消失的彩虹海
...
if(!preg_match("/^[a-f0-9]+$/",$_POST['cookie']) || strlen($_POST['cookie'])!=16)exit('Forbidden!');
if(!preg_match("/^[a-zA-Z0-9.\/]+$/",$_POST['u']) || strlen($_POST['u'])>25)exit('Forbidden!');
//存放Cookies的文件
...
echo '
以下是你的Cookie-ID：<br/><input type="text" value="'.$cookie.'" class="txt"/><br/>请将Cookie-ID填入签到机/任务助手的Cookie-ID一栏。<br/>说明：Cookie-ID相当于你cookie的特征码，不要随意泄露。</div>';
